...
public class WebSecurityConfig {
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http, AuthenticationManager authenticationManager) {
        return http
                ...
                .authorizeExchange(authorizeExchangeSpec -> {
                    authorizeExchangeSpec.pathMatchers(publicRouts)
                            .permitAll();
                })
    ...
    private AuthenticationWebFilter bearerAuthFilter(AuthenticationManager authenticationManager) {
        ...
        AuthenticationWebFilter authenticationWebFilter = new AuthenticationWebFilter((ReactiveAuthenticationManager) authenticationManager);
